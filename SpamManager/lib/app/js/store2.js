...
const store = new Vuex.Store({
    ...
    actions: {
        ...
        {
            axios
            .get('addonmodules.php?module=SpamManager&c=ProductGroups&json=1')
            .then(response => {
        ...
        refreshSupervisors(context) {
            axios
                .get('addonmodules.php?module=SpamManager&c=Supervisors&json=1')
                .then(response => {
                    //this.api = response.data;
        ...
        refreshCustomOffers(context) {
            axios
                .get('addonmodules.php?module=SpamManager&c=CustomOffers&json=1')
                .then(response => {
                    //this.api = response.data;
