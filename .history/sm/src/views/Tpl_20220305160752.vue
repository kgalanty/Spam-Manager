      ...
      <div class="columns is-desktop columnsvisibility">
        <div class="column tplmaintable">
          <b-table :data="table" :mobile-cards="false">
            ...
            <b-table-column centered label="Group" field="name" v-slot="props" width="15%">
              {{ props.row.name }}
            </b-table-column>
            <b-table-column centered label="Group" field="name" v-slot="props">
              <b-table :data="props.row.tpls" class="tpltable">
                <b-table-column
                  ...
                  label="Template"
                  field="name"
                  v-slot="props2" width="15%"
                >
                  {{ props2.row.name }}
                </b-table-column>
                <b-table-column centered label="Server" field="name" width="60%"
                  >
                      <b-taginput style=""
            ...
            <b-table-column
              ...
              field="name"
              v-slot="props"
            > <b-tooltip label="Add New Template to This Group"
            position="is-left">
              <b-button
