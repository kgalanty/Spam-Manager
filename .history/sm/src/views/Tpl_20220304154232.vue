          ...
          <b-table :data="table" :mobile-cards="false">
            <template #footer>
              ...
              <th style="padding: 20px">
                <b-input v-model="name" placeholder="Group name"></b-input>
              </th>
              <th>
                <b-button
            ...
            <b-table-column centered label="Group" field="name" v-slot="props">
              <b-table :data="props.row.tpls" class="tpltable">
                <template #footer>
                  <th>Add New Template</th>
                  <th style="padding: 10px">
                    <b-input v-model="groupname" placeholder="Template name"></b-input>
                  </th>
                  <th>
                    <b-button
                      @click="AddTemplate"
                ...
                <b-table-column centered label="Send E-mail" field="name"
                  ><div class="columns">
...
import AddTplField from '@/components/Templates/AddTplField'
import "buefy/dist/buefy.css";
export default {
  name: "Tpl",
  components: {AddTplField},
  methods: {
    AddGroup()
    {
