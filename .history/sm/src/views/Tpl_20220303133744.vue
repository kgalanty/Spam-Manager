      ...
      <div class="columns is-desktop columnsvisibility">
        <div class="column">
          <b-table :data="table" bordered>
            ...
            ><div class="columns">
            <div class="column">
            <b-select placeholder="Select a server" extended >
              ...
              <optgroup label="Game of Thrones">
               ...
               <b-button @click="edit(props2.row.id)" type="is-info" icon-right="pencil">Send</b-button>
               </div> </div>
            </b-table-column>
                   <b-table-column
                    centered
                    ...
                    width="20%"
                  >
                      <b-button @click="edit(props2.row.id)"   type="is-info"  icon-right="pencil"></b-button>
                       <b-button @click="edit(props2.row.id)" type="is-danger"  icon-right="delete"></b-button>
                  </b-table-column>
                </b-table>
            ...
            <b-table-column
              ...
              v-slot="props"
            >
              <b-button @click="edit(props.row.id)" type="is-info" icon-right="pencil"></b-button>
              <b-button @click="edit(props.row.id)" type="is-danger" icon-right="delete"></b-button>
            </b-table-column>
          </b-table>
