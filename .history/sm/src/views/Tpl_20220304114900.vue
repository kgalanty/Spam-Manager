          ...
          <b-table :data="table" >
            ...
            <b-select placeholder="Select a server" expanded >
              ...
              <optgroup label="Game of Thrones">
               ...
               <b-button @click="edit(props2.row.id)" type="is-link" icon-right="send">Send</b-button>
               </div> </div>
            </b-table-column>
                   <b-table-column
                    centered
                    ...
                    width="20%"
                  >
                      <b-button @click="edit(props2.row.id)"   type="is-info"  icon-right="pencil" size="is-small"></b-button>
                       <b-button @click="edit(props2.row.id)" type="is-danger"  icon-right="delete"  size="is-small"></b-button>
                  </b-table-column>
                </b-table>
            ...
            <b-table-column
              ...
              v-slot="props"
            >
              <b-button @click="edit(props.row.id)" type="is-info" icon-right="pencil" size="is-small"></b-button>
              <b-button @click="edit(props.row.id)" type="is-danger" icon-right="delete" size="is-small"></b-button>
            </b-table-column>
          </b-table>
          <div id="newgroup" class="columns">
            <div class="column ">Add New Group</div>
             <div class="column is-three-quarters"><b-input v-model="name" placeholder="Group name" ></b-input></div>
            <div class="column"><b-button @click="edit(props.row.id)" type="is-danger" icon-right="plus" size="is-small">Add</b-button></div>
          </div>
        </div>
      </div>
    </article>
