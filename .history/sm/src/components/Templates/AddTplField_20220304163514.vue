  ...
  <form action="">
    <div class="modal-card" style="">
      ...
      <footer class="modal-card-foot">
        ...
        <b-button label="Add" @click="AddTemplate" type="is-primary" />
      </footer>
    </div>
  </form>
</template>
...
export default {
  ...
  methods: {
    AddTemplate() {
      if (this.templatename == "" || this.groupid == "") return;
      const params = requestHelper.generateParamsForRequest("Templates", [
        "a=AddNewTemplate",
      ]);
      this.$api
        .post("addonmodules.php?" + params, { groupid: this.groupid, name: this.templatename })
        .then(() => {});
    },
  },
  mounted() {
