    ...
    <div class="modal-card" style="">
      ...
      <section class="modal-card-body">
        ...
        <b-field label="Service Statuses">
          <span class="servicestatuses" v-for="(status, index) in hostingstatuses" :key="index">
            <b-checkbox v-model="checkboxGroup" :native-value="hostingstatuses">
              {{ status }}
            </b-checkbox>
          </span>
        </b-field>
