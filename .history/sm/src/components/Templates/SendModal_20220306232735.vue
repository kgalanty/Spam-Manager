  ...
  <form action="">
    <div class="modal-card" style="">
      ...
      <section class="modal-card-body">
        ...
        <b-field label="Service Statuses">
          <b-checkbox v-model="checkboxGroup" v-for="(status, index) in hostingstatuses"  :key="index"
                :native-value="hostingstatuses">
               <b-field> {{ status }}</b-field>
            </b-checkbox>
          </b-field>
           <b-message type="is-info" has-icon>
            With this form mass mailing can be sent to all owners of accounts utilizing servers selected below.
        </b-message>
      </section>
...
export default {
  ...
  data() {
    return {
      ...
      serversSelected: [],
      hostingstatuses: ['Active', 'Pending', 'Completed', 'Suspended', 'Terminated', 'Cancelled','Fraud']
    };
  },
  watch: {},
};
