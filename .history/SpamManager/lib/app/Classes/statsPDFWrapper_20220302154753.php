...
use WHMCS\Module\Addon\SpamManager\app\DBTables\DBTables;
...
class statsPDFWrapper
{
    ...
    public function releasePDF()
    {
        ...
        // rename($attachment_path, '/var/www/projects/ticketing.stage.tmdhosting.com/modules/addons/SpamManager/pdf/export.pdf');
